package it.plansoft.sql3.dialect;/* ggrosso created on 21/02/2021 inside the package - it.plansoft.demojpa.sql3.dialect */

import it.plansoft.sql3.dialect.identity.SQLiteDialectIdentityColumnSupport;
